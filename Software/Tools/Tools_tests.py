...
o0o1,o1o2,o2o3,o3o4=10,10,10,15     # You can modify these values as you want
...
print ( " MODEL CALCULATIONS Test")
print ("MGD, MGI test")
robotRPRR = Tools ( joint_distances=[o0o1,o1o2,o2o3,o3o4])
q = [0,100,90, 90]
print ("q = ", q)
Xd = robotRPRR.forward_kinematics(q)
print ("Xd=" , Xd)
q_test = robotRPRR.inverse_kinematics (Xd)
print ( "q_test =", q_test)
...
Xp1= [1, 1, 1, 1]
print("Xp1 =",Xp1)
qp = robotRPRR.Direct_differential_kinematics(Xp1, q)
print ("qp = ", qp)
Xp1_test = robotRPRR.Indirect_differentiel_kinematics(qp , q)
print ("Xp1_test = ", Xp1_test)